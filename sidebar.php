                ...
                <div class="aside-list-item">
                    <a href="<?php $comments->permalink(); ?>" class="thumbnail">
                        <?php $email = $comments->mail;
                                ...
                                echo getGravatar($email, $name, null); ?>
                    </a>
                    <div class="content">
        ...
        <div class="card-widget card-webinfo" data-aos="fade-left" data-aos-easing="ease-out" data-aos-duration="4000"
            ...
            <div class="webinfo">
                ...
                let animationActiveUsers = loadAnimation('loadingIconActiveUsers',
                    '/usr/themes/butterfly/img/loading.json');
                ...
                function updateData() {
                    fetch('/usr/themes/butterfly/public/fetchUmamiData.php')
                        ...
                        .then(data => {
                            ...
                            // 更新页面内容
                            document.getElementById('activeUsersCount').textContent = data.activeUsers == 0 ? '1' :
                                data.activeUsers;
