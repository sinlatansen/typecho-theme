...
<header class="not-top-img" id="page-header">
    <!-- github热力图 -->
    <script src="/usr/themes/butterfly/js/d3.v7.min.js"></script>
    <script src="/usr/themes/butterfly/js/cal-heatmap.min.js"></script>
    <link rel="stylesheet" href="/usr/themes/butterfly/css/cal-heatmap.css">
...
<main class="layout" id="content-inner">
    <div id="page" style="width:100%;min-height: 100vh;">
        ...
        <div id="cninfo">
            ...
            <p>喜欢折腾浪费时间的东西，这种极客精神的启蒙是初一时候爷爷偷偷给我买的那部红米NOTE。那时候的精神家园是小米贴吧，现在是<img src="/usr/themes/butterfly/img/reddit.svg" class="svg-icon" style="height:40px;" alt="SVG图标">。</p>
