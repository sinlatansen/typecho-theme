    ...
    <div id="footer-wrap">
      ...
      <script>
        ...
        function updateRunTime() {
          ...
          // 更新页面上显示的时间
          document.getElementById('runTimeDisplay').innerHTML = days + " 天 " + hours + " 小时 " + minutes + " 分钟 " + seconds + " 秒";
        }
